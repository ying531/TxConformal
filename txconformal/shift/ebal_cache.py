...
class ebal_bin_cache:
    ...
    def __init__(self, 
        ...
        self.PCA = PCA
        self.effect = effect
        self.ratio_bound = PCA_ratio_bound
        self.var_bound = PCA_var_bound
    ...
    def ebalance(
        ...
        if self.PCA:
            ...
            X = X_c_pca[:,(pca.explained_variance_>= self.var_bound) | (pca.explained_variance_ratio_>=self.ratio_bound)]#0.001)]
        ...
        return {'converged': self.converged, 'maxdiff': self.maxdiff, 'w':w}
    # , "wls":wls_results}
